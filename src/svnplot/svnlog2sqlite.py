...
class SVNLog2Sqlite:
    def __init__(self, svnrepopath, sqlitedbpath, svnrevstartdate, svnrevenddate, verbose=False):
        self.svnclient = svnlogiter.SVNLogClient(svnrepopath, svnrevstartdate, svnrevenddate, BINARYFILEXT)
...
def RunMain():
    ...
    if( len(args) < 4):
        ...
        svnrepopath = args[0]
        sqlitedbpath = args[1]
        svnrevstartdate = args[2]
        svnrevenddate = args[3]
        ...
        try:
            ...
            conv = None            
            conv = SVNLog2Sqlite(svnrepopath, sqlitedbpath, svnrevstartdate, svnrevenddate, verbose=options.verbose)
