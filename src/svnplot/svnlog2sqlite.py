...
import svnlogiter
from svnlogclient import SVNLogClient, normurlpath
...
class SVNLog2Sqlite:
    def __init__(self, svnrepopath, sqlitedbpath,verbose=False,**kwargs):
        ...
        self.svnclient = SVNLogClient(svnrepopath,BINARYFILEXT,username=username, password=password)
